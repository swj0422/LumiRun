  ...
  routes: [
    ...
    // 管理者端
    {
      ...
      children: [
        ...
        {
          path: 'wish-wall',
          name: 'TeacherWishWall',
          component: () => import('@/views/pc/teacher/WishWall.vue'),
        },
      ],
    },
    // 组织助理端
    ...
    // 管理员端
    {
      ...
      children: [
        ...
        },
        {
          path: 'classes',
          name: 'AdminClasses',
          component: () => import('@/views/pc/admin/ClassList.vue'),
        },
        {
          path: 'students',
          name: 'AdminStudents',
          component: () => import('@/views/pc/admin/StudentList.vue'),
        },
        {
          path: 'gifts',
          name: 'AdminGifts',
          component: () => import('@/views/pc/admin/GiftList.vue'),
        },
        {
          path: 'orders',
          name: 'AdminOrders',
          component: () => import('@/views/pc/admin/OrderList.vue'),
        },
        {
          path: 'suggestions',
          name: 'AdminSuggestions',
          component: () => import('@/views/pc/admin/SuggestionList.vue'),
        },
        {
          path: 'wishes',
          name: 'AdminWishes',
          component: () => import('@/views/pc/admin/WishList.vue'),
        },
        {
          path: 'logs',
          name: 'AdminLogs',
